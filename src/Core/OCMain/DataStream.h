...
namespace OC {
	...
	*/
	class _MainExport MemoryDataStream : public DataStream
	{
	protected:
		...
		bool mFreeOnClose;			
	public:
		MemoryDataStream(StringStream* s, bool freeOnClose = true, bool readOnly = false);
    ...
    */
    ...
    /** Common subclass of DataStream for handling data from 
		std::basic_istream.
	*/
	class _MainExport FileStreamDataStream : public DataStream
	{
	protected:
